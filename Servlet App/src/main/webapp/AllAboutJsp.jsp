...
<div class="container">
    ...
    <p><a href="index.html">Go To Random Stuff</a></p>
    <p><a href="ShowPhones.jsp">See All Phones</a></p>
    ...
    <div class="section">
        ...
        <div class="code">
            ...
            < %@page import="com.yogesh.User"%><br/>
    ...
    <div class="section">
        <h2>Setting Attributes in Page Context</h2>
        <p>You can set attributes in the page context with various scopes (session, page, application).</p>
        <div class="code">
            < % 
                // Setting an attribute with session scope
                pageContext.setAttribute("message", "This is a session scoped attribute", PageContext.SESSION_SCOPE);
            %>
        </div>
    </div>
